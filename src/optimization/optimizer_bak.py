...
def prep_optimizer(args, model):
    if args.model == "pretrained":
    ...
    elif args.model == "pretrained2":
        param_dicts = list(model.named_parameters())
        no_decay = ['bias', 'LayerNorm.bias', 'LayerNorm.weight']

        decay_param_tp = [(n, p) for n, p in param_dicts if not any(nd in n for nd in no_decay)]
        no_decay_param_tp = [(n, p) for n, p in param_dicts if any(nd in n for nd in no_decay)]
        ...
        optimizer_grouped_parameters = [
            {'params': [p for n, p in decay_clip_param_tp], 'weight_decay': weight_decay, 'lr': args.lr * args.coef_lr},
            {'params': [p for n, p in decay_noclip_param_tp], 'weight_decay': weight_decay},
            {'params': [p for n, p in no_decay_clip_param_tp], 'weight_decay': 0.0, 'lr': args.lr * args.coef_lr},
        ...
        optimizer = BertAdam(optimizer_grouped_parameters, lr=args.lr, warmup=args.warmup_proportion,
                            ...
                            t_total=args.num_train_optimization_steps, weight_decay=weight_decay,
                            max_grad_norm=1.0)

    else:
        if args.bias_non_decay:
